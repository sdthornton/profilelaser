...
<!DOCTYPE html>
<!--[if lt IE 7]>      <html class="no-js ie lt-ie9 lt-ie8 lt-ie7 hover"> <![endif]-->
<!--[if IE 7]>         <html class="no-js ie lt-ie9 lt-ie8 hover"> <![endif]-->
<!--[if IE 8]>         <html class="no-js ie lt-ie9 hover"> <![endif]-->
<!--[if IE 9]>         <html class="no-js ie hover"> <![endif]-->
<!--[if gt IE 9]><!--> <html class="no-js hover"> <!--<![endif]-->
<head>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="css/main.20130521.css">
